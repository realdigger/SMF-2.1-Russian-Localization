...
$txt['search_thisbrd'] = 'В этом разделе';
...
$txt['welcome_guest'] = 'Добро пожаловать, <strong>%1$s</strong>. <a href="%3$s" onclick="%4$s">Войдите</a>.';
...
$txt['welcome_guest_register'] = 'Добро пожаловать на <strong>%2$s</strong>. <a href="%3$s" onclick="%4$s">Войдите</a> или <a href="%5$s">зарегистрируйтесь</a>.';
...
$txt['post_becomesUnapproved'] = 'Ваше сообщение стало неодобренным, потому что было отправлено в неодобренную тему. Как только тема будет одобрена, ваше сообщение станет тоже одобренным.';
...
$txt['target_id'] = 'Выберите тему для объединения по ее ID';
...
$txt['page_created_full'] = 'Страница создана за %1$.3f секунд с %2$d запросами.';
...
$txt['notify_topic_1'] = 'Без электронных уведомлений и оповещений';
$txt['notify_topic_2'] = 'Получать оповещения';
$txt['notify_topic_3'] = 'Получать уведомления по электронной почте и оповещения';
...
$txt['notify_board_1'] = 'Без уведомлений по электронной почте и оповещений';
