...
$txt['birthday_email'] = 'Используемый шаблон для поздравлений с днём рождения';
$txt['birthday_body'] = 'Содержание сообщения';
$txt['birthday_subject'] = 'Тема сообщения';

$txt['mailtest_header'] = 'Тестовое электронное сообщение';
$txt['mailtest_result_success'] = 'Тестовое сообщение успешно отправлено';
$txt['mailtest_result_failure'] = 'Не удалось отправить тестовое сообщение, проверьте <a href="%1$s">логи ошибок</a>, чтобы узнать подробности.';
