...
// Don't use entities in the below string.
$txt['package_theme_failure_warning'] = 'Как минимум одна ошибка возникла при тестовой установке пакета в эту тему оформления. Хотите продолжить установку?';
...
$txt['package_install_options_ftp_why'] = 'Используя FTP-интерфейс менеджера пакетов, можно вручную выставить права на запись необходимым файлам.<br>Здесь можно указать стандартные значения для вашего сервера.';
