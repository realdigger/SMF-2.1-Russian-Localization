...
$txt['popup_summary'] = 'Сводка';
$txt['popup_showposts'] = 'Сообщения';
...
$txt['sig_info'] = 'Этот текст будет отображаться под каждым вашим сообщением.<br>Для оформления можно использовать ББ-теги и смайлики.';
...
$txt['alert_unapproved_attachment'] = 'При добавлении неодобренного вложения';
...
$txt['statPanel_topBoards'] = 'Активность в разделах (количество сообщений)';
...
$txt['profile_error_signature_allow_smileys'] = 'Вам не разрешено использовать какие-либо смайлики в своей подписи';
$txt['profile_error_signature_max_smileys'] = 'Нельзя использовать в подписи более %1$d смайликов';
...
$txt['tfadisable'] = 'Отключить двухфакторную аутентификацию';
$txt['tfa_profile_label'] = 'Двухфакторная аутентификация';
$txt['tfa_profile_desc'] = 'Двухфакторная аутентификация позволяет улучшить безопасность, назначив отдельное устройство, без которого никто не сможет войти в ваш аккаунт, даже если у него есть ваш логин и пароль';
$txt['tfa_profile_enable'] = 'Включить двухфакторную аутентификацию';
$txt['tfa_profile_enabled'] = 'Двухфакторная аутентификация включена. <a href="%s">Выключить</a>';
$txt['tfa_profile_disabled'] = 'Двухфакторная аутентификация выключена';
$txt['tfa_title'] = 'Включить двухфакторную аутентификацию через совместимое приложение';
$txt['tfa_desc'] = 'Для использования двухфакторной аутентификации на вашем устройстве вам может понадобиться совместимое приложение, такое как Google Authenticator. Если вы включите двухфакторную аутентификацию для вашего аккаунта, вы должны будете вводить код, отображаемый на спаренном устройстве, помимо логина и пароля. После включения двухфакторной аутентификации вам будет предоставлен код восстановления, на случай утери спаренного с аккаунтом устройства.';
$txt['tfa_forced_desc'] = 'Администратор принудительно включил двухфакторную аутентификацию для всех аккаунтов, для продолжения включите её здесь тоже';
...
$txt['tfa_backup_used_desc'] = 'Вы ввели верный код восстановления и двухфакторная аутентификация отключена. Если вы хотите использовать двухфакторную аутентификацию снова, включите её здесь';
...
$txt['tfa_backup_desc'] = 'Если вы потеряли устройство или приложение для авторизации, можно использовать код восстановления, заданный при настройке двухфакторной аутентификации. В случае утери и этого кода свяжитесь с администратором форума.';
$txt['tfa_wait'] = 'Подождите около 2 минут, прежде чем пробовать войти снова через двухфакторную аутентификацию';
$txt['tfa_disable_for_user'] = 'Это отключит двухфакторную аутентификацию для %s.';
$txt['cannot_disable_tfa'] = 'Двухфакторную аутентификацию отключить нельзя, так как она требуется для всех учетных записей.';
$txt['cannot_disable_tfa2'] = 'Вы не можете отключить двухфакторную аутентификацию, поскольку для одной из групп, в которой вы состоите. За дополнительной информацией обращайтесь к администратору.';
