...
$txt['admin_webmaster_email'] = 'Электронный адрес веб-мастера';
...
$txt['guest_post_no_email'] = 'Не показывать поле с электронным адресом в сообщениях гостей';
...
$txt['smf_news_cant_connect'] = 'Невозможно соединиться с simplemachines.org для получения последних новостей.';
...
$txt['errorlog_desc'] = 'Журнал ошибок содержит записи обо всех обнаруженных в работе форума ошибках. Для удаления записи об ошибке выберите её и нажмите кнопку «%1$s» внизу страницы.';
...
$txt['smileys_default_set_for_theme'] = 'Выбрать смайлики по умолчанию для этой темы';
$txt['smileys_no_default'] = '(использовать смайлики по умолчанию)';
...
$txt['manageposts_bbc_settings_description'] = 'ББ-код может использоваться для оформления сообщений. Пример жирного выделения слова «лошадь»: [b]лошадь[/b]. Все ББ-теги обрамляются квадратными скобками (\'[\' и \']\').';
...
$txt['legacyBBC'] = 'Устаревшие ББ-теги';
$txt['bbcTagsToUse'] = 'Разрешить ББ-теги';
$txt['enabled_bbc_select'] = 'Выберите теги, которые можно использовать';
$txt['enabled_bbc_select_all'] = 'Выбрать все теги';
$txt['groups_can_use'] = 'Группы с правом использовать %1$s';
...
$txt['smiley_sets'] = 'Установленные смайлики';
$txt['smileys_add'] = 'Добавить смайлики';
$txt['smileys_edit'] = 'Изменить смайлики';
$txt['smileys_set_order'] = 'Порядок смайликов';
...
$txt['enable_sm_stats'] = 'Разрешить сбор статистики';
