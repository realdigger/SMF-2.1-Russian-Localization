...
$txt['search_method_fulltext_cannot_create'] = 'невозможно создать, поскольку полнотекстовый поиск не поддерживается текущей версией MySQL, установленной на сервере';
...
$txt['spider_mode_note'] = 'Помните, что запись в лог каждого действия пауков происходит только при установке уровня отслеживания в «Высокий» или «Очень высокий». Детализация каждого действия пауков записывается в лог только при установке уровня отслеживания в «Очень высокий».';
...
$txt['spider_group_note'] = 'Чтобы запретить паукам индексировать некоторые страницы.';
...
$txt['spider_log_empty_log'] = 'Очистить лог';
$txt['spider_log_empty_log_confirm'] = 'Хотите полностью очистить лог?';
...
$txt['spider_stats_delete_older'] = 'Удалить всю статистику пауков, которые не заходили %1$s дней.';

// Don't use entities in the below string.
$txt['spider_logs_delete_confirm'] = 'Хотите удалить все записи?';
