...
$txt['permissionname_manage_smileys'] = 'Управление смайликами и иконками сообщений';
$txt['permissionhelp_manage_smileys'] = 'Эти права доступа позволяют пользователям управлять смайликами форума. Удалять, добавлять, редактировать смайлики и их наборы. Если разрешены дополнительные иконки сообщений, то добавлять и изменять их, тоже.';
