...
$txt['error_unexpected_template_call'] = "\n" . 'Ошибка: неожиданный вызов для использования шаблона %1$s. Пожалуйста, скопируйте весь текст выше и передайте его разработчикам SMF, чтобы они могли разобраться с этой ошибкой.';
...
$txt['error_php_too_low'] = 'Предупреждение! На веб-сервере не установлена версия PHP, соответствующая минимальным требованиям SMF к установке.<br><br>Пожалуйста, попросите вашего хостера осуществить обновление.';
...
$txt['error_db_privileges'] = 'Пользователь %1$s, указанный в Settings.php, не имеет надлежащих привилегий.<br><br>Пожалуйста, попросите ваш хост дать этому пользователю права на ИЗМЕНЕНИЕ, СОЗДАНИЕ и УДАЛЕНИЕ.';
...
$txt['error_agreement_not_writable'] = 'Программе установки не удалось получить доступ для записи к файлу agreement.txt.<br><br>Если вы используете сервер Linux или Unix, убедитесь, что на файл (или директорию, в которой находится этот файл) установлены права 777.<br>Если ваш сервер работает под управлением Windows, убедитесь, что у гостевой учетной записи есть необходимые разрешения для этого файла или папки, в которой он находится.';
$txt['error_settings_migration_no_var'] = 'Программа обновления не может скопировать параметр (%1$s) из вашего файла настроек. Невозможно перенести Settings.php в новый файл.';
$txt['error_settings_migration_too_short'] = 'Программа обновления не может обработать ваш файл настроек. Невозможно перенести Settings.php в новый файл.';
$txt['error_settings_migration_write_failed'] = 'Программа обновления не может записать тестовый файл. Возможно, недостаточно места на диске? Невозможно перенести Settings.php в новый файл.';
$txt['error_settings_migration_general'] = 'Программа обновления обнаружила неверный файл настроек и отменила изменения. Невозможно перенести Settings.php в новый файл.';
