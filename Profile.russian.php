...
$txt['notify_send_type_everything_own'] = 'изменении темы модератором, если я автор темы и слежу за ней';
...
$txt['alert_opt_msg_notify_type'] = 'Уведомлять меня при:';
...
$txt['alert_topic_notify'] = 'При ответе в теме, на которую я подписан уведомлять через...';
$txt['alert_board_notify'] = 'При создании темы в разделе, на который я подписан уведомлять через...';
$txt['alert_msg_mention'] = 'При упоминании моего @ника в сообщении';
$txt['alert_msg_quote'] = 'При цитировании моего сообщения (если я не подписан на тему)';
...
$txt['alert_member_report_reply'] = 'При получении ответ на жалобу на профиль пользователя';
