...
$txt['permissionhelp_poll_vote'] = 'Позволяет зарегистрированным пользователям участвовать в голосованиях. <br><br><strong>Примечание по гостям:</strong> SMF использует куки для попытки предотвращения повторных голосований тем же гостем. Тем не менее, имейте в виду, что это не гарантирует, что один и тот же гость не сможет проголосовать несколько раз. Так же, голосование для гостей должно быть дополнительно разрешено при создании каждого голосования.';
