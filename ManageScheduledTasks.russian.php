...
$txt['cron_is_real_cron_desc'] = '<strong>Не устанавливайте этот флажок</strong>, если не <strong><u>уверены</u></strong>, что настроили другой метод, чтобы регулярно запускать файл cron.php.';
