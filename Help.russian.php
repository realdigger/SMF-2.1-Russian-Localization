...
global $helptxt, $scripturl, $boarddir, $boardurl;
...
$helptxt['smileys'] = '<strong>Смайлы и иконки</strong><br>
	Здесь можно добавлять, удалять смайлы, или наборы смайлов. Заметьте, что если смайл один в наборе, то он появляется во всех наборах &mdash; иначе он может смутить ваших пользователей, использующих разные наборы.<br><br>
...
$helptxt['cal_enabled'] = 'Календарь может быть использован для отображения дней рождений или важных событий, происходящих в вашем сообществе.<br><br>
		<strong>Показывать дни как ссылку на \'Добавить событие\'</strong>:<br>Это разрешит пользователям добавлять события в тот день, когда они нажмут на этой дате<br>
...
$helptxt['globalCookies'] = 'Использование кросс-доменных куки. Например, если...<br>
	ваш сайт расположен по адресу https://www.example.com/,<br>
	А ваш форум https://forum.example.com/,<br>
	Используя эту функцию, пользователи могут заходить на ваш сайт, используя кросс-доменные куки вашего форума. Не применяйте эту функцию, если используются какие-то другие домены (Например, hacker.simplemachines.org), которые не принадлежат вам.';
...
$helptxt['minimize_files'] = 'Эта опция минимизирует все CSS и JS файлы, используемые форумом, сократив количество запросов к серверу и время загрузки страниц для пользователей.<br><br>Обычно эту опцию следует оставить включенной. Единственным случаем, когда вы, возможно, захотите отключить её — при редактировании каких-либо CSS или JS файлов (например, при редактировании темы оформления или при разработке модификации).';
	...
	<ul class="normallist">
		<li>
			...
			<strong>Активация пользователя</strong><br>
				Означает, что пользователь должен активировать свою учётную запись &mdash; путем перехода по ссылке, присланной по электронной почте.<br>
		</li><li>
...
$helptxt['latest_themes'] = 'Здесь отображаются последние и самые популярные темы оформления с сайта <a href="https://www.simplemachines.org/" target="_blank" rel="noopener">www.simplemachines.org</a>. Если темы не отображаются, форум не может подключиться к серверу <a href="https://www.simplemachines.org/" target="_blank" rel="noopener">www.simplemachines.org</a>.';
...
$helptxt['membergroups'] = 'Существует два вида групп пользователей:
	<ul class="normallist">
		...
		<li><strong>Группа, основанная на сообщениях:</strong> В отличие от постоянной группы группа, основанная на сообщениях, не может быть присвоена администратором пользователю. Пользователи автоматически переходят из группы в группу, набирая необходимое количество сообщений.</li>
	</ul>';
