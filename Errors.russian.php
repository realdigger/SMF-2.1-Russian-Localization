...
$txt['package_get_error_is_theme'] = 'Установка тем в данном разделе недоступна. Пожалуйста, используйте страницу <a href="{MANAGETHEMEURL}">Темы оформления</a> для загрузки';
