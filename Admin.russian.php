...
$txt['errlog_desc'] = 'Журнал ошибок содержит записи обо всех обнаруженных в работе форуме ошибках. Для удаления записи об ошибке, выберите её и нажмите кнопку %1$s внизу страницы.';
...
$txt['log_ban_hits'] = 'Записывать срабатывания банов в лог ошибок?';
